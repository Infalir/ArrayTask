...
public class ArrayStreamCalculateImplTest {
    private CustomArray array;
    private ArrayStreamCalculateImpl calculator;

    @BeforeEach
    public void setUp() throws ArrayException{
        int[] tempArray = {7, 3, -1, 0, 18, -3};
        array = new CustomArray(tempArray, 0);
        calculator = new ArrayStreamCalculateImpl();
    }
    ...
    @Test
    public void testFindNegativeAmount()throws ArrayException{
